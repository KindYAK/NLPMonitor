#!/usr/bin/python
# python es_test_data.py --es_url=http://localhost:9500 --index_name=big_ssd_10 --batch_size=1000 --num_of_shards=2 --num_of_replicas=0 --force_init_index=True --count=20000
...
def create_index(idx_name):
    schema = {
        "settings": {
            ...
            "index.routing.allocation.include.disk": tornado.number_of_replicas.options.disk_type
        }
    }
...
if __name__ == '__main__':
    ...
    tornado.options.define("disk_type", type=str, default='hdd', help="Name of the storage attribute")
    ...
    tornado.options.define("num_of_shards", type=int, default=6, help="Number of shards for ES index")
    ...
    tornado.options.define("num_of_replicas", type=int, default=4, help="Number of replicas for ES index")
