...
%- block body
    ...
    \BLOCK{if dynamics.dynamics_posneg}
        ...
        \begin{figure}[H]
            \centering\includegraphics[width=0.9\textwidth,keepaspectratio]{\pathdynamicsposneg}
        \end{figure}
    \BLOCK{endif}
    ...
    \begin{figure}[H]
        \centering\includegraphics[width=0.9\textwidth,keepaspectratio]{\pathsources}
    \end{figure}
